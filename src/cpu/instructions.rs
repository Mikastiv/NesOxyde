...
lazy_static! {
    pub static ref INSTRUCTIONS: Vec<Instruction> = vec![
        ...
        Instruction::new(0x32, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
        Instruction::new(0x42, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
        Instruction::new(0x52, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
        Instruction::new(0x62, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
        Instruction::new(0x72, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
        Instruction::new(0x92, KIL, |cpu, mode| cpu.kil(mode), AddrMode::Imp, 0),
